...
ODataServer.prototype._initializeRoutes = function () {
  ...
  this.router.get('/\$metadata', function (req, res) {
    ...
    res.writeHead(200, {'Content-Type': 'application/xml', 'DataServiceVersion': '3.0', 'OData-Version': '3.0'})
  ...
  this.router.get('/', function (req, res) {
    ...
    res.writeHead(200, {'Content-Type': 'application/json'})  //TODO need to return in XML
    return res.end(result)
  })
